...
cur.execute(query)
first_rtx = cur.fetchone()
first_rt = first_rtx[0]
conn.close()
#pdb.set_trace()
...
#pdb.set_trace()
print(set([x[3][:2] for x in more_than_2_rts]))
...
def get_twitter_users(string):
	return set(re.findall("@([A-aZ-z0-9_]+)",string))
